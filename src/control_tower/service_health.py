    ...
    *,
    ...
    return {
        ...
        "service_meta": {
            ...
            "proof_assets": [
                {"label": "Health Audit", "path": "make health", "kind": "command"},
                {"label": "Control Tower", "path": "app/dashboard.py?page=control-tower", "kind": "surface"},
                {"label": "Evidence Pack", "path": "scripts/scenario_runner.py", "kind": "script"},
                {"label": "Audit Chain Check", "path": "scripts/verify_audit.py", "kind": "script"},
            ],
            "review_pack": {
